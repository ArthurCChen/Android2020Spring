...
//开启地图定位图层
    ...
    private void getLocationByLL(double la, double lo){
    ...
    protected void judgePermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(this, ACCESS_FINE_LOCATION[0]) != PackageManager.PERMISSION_GRANTED) {
                // 如果没有授予该权限，就去提示用户请求
                ActivityCompat.requestPermissions(this, ACCESS_FINE_LOCATION, 700);
            }
